...
const SideBarList = (props) => {
  ...
  const handleItemClick = (item, event) => {
    ...
    if (props.isEditing && props.method === "POST") {
      event.preventDefault(); // Prevent navigation when in add mode
