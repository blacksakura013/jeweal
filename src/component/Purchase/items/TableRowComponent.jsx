          ...
          >
            <Component
              ...
              disabled={(() => {
                ...
                // For memo pending data, only allow editing specified fields
                if (rows?.[index]?.isFromMemoPending) {
                  return !editableFieldsInDaybook.includes(key);
                }
                
                // For PO data, only allow editing specific business fields
                if (rows?.[index]?.isFromPO) {
                  return !["pcs", "weight_per_piece", "weight", "price", "unit", "discount_amount", "discount_percent", "remark"].includes(key);
                }
