...
import {
  SidebarMenuBox,  ButtonOnNavBarWithRightArrow,
  DropdownMenuBox,
  TextButton,
  TextMain,
  Dropdownmenu,
          ...
          <Box>
            <Box sx={Dropdownmenu}  className="hovered-box">
              <Link to="/settings/main-location">
                <Typography sx={TextMain}>Main Location</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu}  className="hovered-box">
             
              <Link to="/settings/sub-location">
                <Typography sx={TextMain}>Sub Location</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu}  className="hovered-box">
            
              <Link to="/settings/currency">
                <Typography sx={TextMain}>Currency</Typography>
              </Link>
            </Box>
          </Box>
        </Box>
