...
import { TextButton , ButtonOnNavBarWithOutRightArrow , SidebarMenuBox } from "../../../Assets/styles/NavbarStyles.jsx";

const Home = () => {
  return (
    <Box >
      <Box
      sx={SidebarMenuBox} className="sidebar-menu-box" 
      >
        ...
        <Link to="/home">
        <Typography className="hovered-text" sx={TextButton}>Home</Typography>
        </Link>
      </Box>
    </Box>
  );
