        ...
        <Box sx={{ display: "flex", alignItems: "center", marginLeft: "12px" }}>
          ...
          <Typography
            ...
            sx={[
              ...
              {
                color: showRedBox === "Stone Master" ? "#05595B" : "#FFF",
              },
            ]}
          >
            Stone Master
          ...
          <Box>
            <Box sx={Dropdownmenu}  className="hovered-box">
              <Link to="/stone-master/stone-group">
                <Typography sx={TextMain}>Stone Group</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/stone/">
                <Typography sx={TextMain}>Stone</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/shape/">
                <Typography sx={TextMain}>Shape</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/size/">
                <Typography sx={TextMain}>Size</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/color">
                <Typography sx={TextMain}>Color</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/cutting/">
                <Typography sx={TextMain}>Cutting</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/quality/">
                <Typography sx={TextMain}>Quality</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/clarity/">
                <Typography sx={TextMain}>Clarity</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu} className="hovered-box">
              <Link to="/stone-master/certificate-type/">
                <Typography sx={TextMain}>Certificate Type</Typography>
              </Link>
            </Box>
            <Box sx={Dropdownmenu }  className="hovered-box">
              <Link to="/stone-master/labour-type/">
                <Typography sx={TextMain}>Labour Type</Typography>
              </Link>
            </Box>
          </Box>
        </Box>
