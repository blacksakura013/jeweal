...
import { quotationFSMState } from "../../recoil/state/QuotationFSMState.js";
...
const QuotationsOrderBody = ({
  ...
  const fsmState = useRecoilValue(quotationFSMState);
  
 
  const shouldDisableFields = fsmState === "saved" && !editMemoStatus;
