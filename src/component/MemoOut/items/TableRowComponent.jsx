...
import { memoInfoState } from "recoil/MemoOut.js";
    ...
    const fields = [
      {
        ...
        options: dropdownOptions?.stone || [], disabled: true
      },
      {
        key: "shape",
        component: CustomSelectInput,
        options: dropdownOptions?.shape || [], disabled: true
      },
      {
        key: "size",
        component: CustomSelectInput,
        options: dropdownOptions?.size || [], disabled: true
      },
      {
        key: "color",
        component: CustomSelectInput,
        options: dropdownOptions?.color || [], disabled: true
      },
      {
        key: "cutting",
        component: CustomSelectInput,
        options: dropdownOptions?.cutting || [], disabled: true
      },
      {
        key: "quality",
        component: CustomSelectInput,
        options: dropdownOptions?.quality || [], disabled: true
      },
      {
        key: "clarity",
        component: CustomSelectInput,
        options: dropdownOptions?.clarity || [], disabled: true
      },
      {
        key: "cer_type",
        component: CustomSelectInput,
        options: dropdownOptions?.cerType || [], disabled: true
      },
      { key: "cer_no", component: CustomTextField, disabled: true },

      { key: "type", component: CustomTextField, disabled: true },
      {
        key: "pcs",
      ...
      { key: "weight_per_piece", component: CustomTextField ,type:"number" , decimal: 2 , disabled: false, bgHighlight: false},
      { key: "weight", component: CustomTextField, type: "number"  , decimal: 3},
      { key: "price", component: CustomTextField, type: "number" ,  decimal: 2 },
      {
        key: "unit",
        component: CustomSelectInput,
        options: dropdownOptions?.unit || [], disabled: false
      },
      { key: "amount", component: CustomTextField, type: "number", bgHighlight: true, disabled: true ,  decimal: 2 },
      { key: "discount_percent", component: CustomTextField, type: "number",  decimal: 2 },
      { key: "discount_amount", component: CustomTextField, type: "number" ,  decimal: 2 },
      { key: "totalAmount", component: CustomTextField, type: "number", bgHighlight: true, disabled: true  ,  decimal: 2},

      { key: "ref_no", component: CustomTextField, disabled: false, bgHighlight: false },
      {
        key: "remark",
        component: CustomTextField,
        width: 412,
        ...
        <Box
          className="sticky-col-2 sticky-col-text"
            ...
            alignItems: "center",
             ...
             <Box                onClick={() => {
            if (disabled) return;
            const input = document.getElementById(`memo-out-pic-input-${index}`);
          ...
          <input
            ...
            onChange={(e) => {
              ...
              // Store preview and raw File for multipart upload
              setRows((prev) => {
                const newRows = [...prev];
                newRows[index] = {
                  ...newRows[index],
          ...
          >
            <Component
              ...
              disabled={
                ...
                ["stone_code", "location", "type", "lot_no"].includes(key) ||
                (![
                  "weight",
                  "cer_no",
                  "cer_type",
