...
import { QuotationtableRowsState, QuotationtableRowsDropdownData } from "recoil/PurchaseOrder/PurchaseOrderState";
  ...
  return (
     <Box
       ...
       >
         ...
         <Box sx={{ width: "1500px", display: "flex", justifyContent: "center", alignItems: "center", }} >
         </Box>
   
   
   <Box sx={{ width: "126px", display: "flex", justifyContent: "center", alignItems: "center"}}>
    <TextField
      value={totalPcs} 
      variant="outlined"
      fullWidth
