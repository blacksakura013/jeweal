...
import { editMemoState } from "recoil/PurchaseOrder/MemoState.js";
import { useRecoilState, useRecoilValue } from "recoil";
import {
  QuotationtableRowsState,
  QuotationtableRowsDropdownData,
} from "recoil/PurchaseOrder/PurchaseOrderState";
import PurchaseModalFromStock from "./PurchaseModalFromStock";
...
const SelectedDataComponent = ({
  ...
  disabled = false,
  isDayBookEdit = false,
  triggerFSMDirty, // Add FSM trigger
  ...
  return (
    <>
      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
        ...
        <PurchaseModalFromStock handleSubmit={handleStockSubmit} isApproved={isApproved} />
      </Box>
