...
import { reserveFSMState } from "../../recoil/state/ReserveFSMState.js";
...
const ReserveBody = ({
  ...
  const [fsmState] = useRecoilState(reserveFSMState);

  const shouldDisableFields = (fsmState === "saved" && !editMemoStatus) || (memoInfo?.isDayBookEdit && !editMemoStatus);

  const getCurrencyForSummary = memoInfo?.currencyCode || "";
  ...
  return (
    <>
      ...
      >
        <Box sx={{ width: "1640px", height: "540px", opacity: 1 }}>
