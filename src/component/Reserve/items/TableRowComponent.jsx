...
const TableRowComponent = React.memo(
  ({
    ...
    const fields = [
      ...
      { key: "amount", component: CustomTextField, type: "number", bgHighlight: true, decimal: 2 },
      ...
      { key: "totalAmount", component: CustomTextField, type: "number", bgHighlight: true, decimal: 2 },
      {
        key: "labour",
        component: CustomTextField,
        options: dropdownOptions?.labour || [],
      },
      { key: "labour_price", component: CustomTextField, type: "number", decimal: 2 },
      {
        key: "remark",
        component: CustomTextField,
        width: 336,
