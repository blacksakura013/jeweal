...
const Footer = (props) => {
  ...
  console.log(props)
    ...
    const [confirmValue, setConfirmValue] = useRecoilState(activeEditButtonState);
  ...
  return (
    <>
      ...
      >
        ...
        <Button
            disabled={editStatus===true||isEditing===true?false:true}
        ...
        //   }
          ...
          sx={{
            ...
            borderRadius: "4px",
            marginRight: "32px",
            backgroundColor: editStatus||isEditing===true ? "#05595B" : "gray" ,
            "&:hover": {
              backgroundColor: editStatus||isEditing===true ?"#05595B" :  "gray" ,
            },
          }}
...
<g clip-path="url(#clip0_2788_204916)">
