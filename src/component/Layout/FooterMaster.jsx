...
if(props.method=="put"){
  ...
  console.log(props.selectedData.master_info)
    ...
    if(master_type=="master_stone_shape"){
      console.log("Footer - master_stone_shape selectedData:", props.selectedData);
      console.log("Footer - master_stone_shape size_ids:", props.selectedData.master_info?.size_ids);
      ...
      console.log("Footer - master_stone_shape final data:", data);
    }
...
if(props.method=="post"){
   ...
   response = await axios.put(
    ...
    console.log("Footer - Data to be posted:", props.selectedData);
    console.log("Footer - Final data being sent to API:", data);
  };
  ...
  useEffect(() => {
    if (props.responseMessage) {
      if (props.responseMessage === "500") {
        setOpenUnsuccess(true);
      }
      if (props.responseMessage === "200") {
        setOpenSuccess(true);
      }
    }
