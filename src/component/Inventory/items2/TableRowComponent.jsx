...
const TableRowComponent = React.memo(
  ...
  const [pcsValidationError, setPcsValidationError] = useState(false);
    ...
    const fields = React.useMemo(() => ([
      ...
      { key: "weight_per_piece", component: CustomTextField ,type:"number", disabled: isApproved},
      { key: "weight", component: CustomTextField, type: "text", noDecimal: false, disabled: isApproved },
      { key: "price", component: CustomTextField, type: "number", disabled: true},
      {
        key: "unit",
        component: CustomSelectInput,
      ...
      { key: "amount", component: CustomTextField, type: "number", disabled: isFromDayBook || isApproved},
    
        { key: "stock_price", component: CustomTextField, type: "number", disabled: isApproved},
         {
        key: "stock_unit",
        component: CustomSelectInput,
        options: dropdownOptions?.unit || [],
      ...
      { key: "stock_amount", component: CustomTextField, type: "number", disabled: true},
         { key: "sale_price", component: CustomTextField, type: "number", disabled: isApproved},
           {
        key: "sale_unit",
        component: CustomSelectInput,
        options: dropdownOptions?.unit || [],
      ...
      { key: "sale_amount", component: CustomTextField, type: "number", disabled: true},
