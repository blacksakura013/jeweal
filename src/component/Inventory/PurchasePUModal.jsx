...
const textStyle = {
  ...
  const handleCheckboxChange = (row, rowIndex) => {
    setSelectedRows((prev) => {
      // Create a unique identifier using _id (if available) or a combination of pu_item_id and index
      // This prevents multiple rows with the same pu_item_id from being selected together
      ...
      // If no _id, use the uniqueId we stored
      const isSelected = prev.some((selectedRow) => {
        // If selectedRow has __uniqueId, use it; otherwise generate from pu_item_id
