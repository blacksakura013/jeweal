            ...
            <TableBody>
              {filteredData.map((group) => (
                <React.Fragment key={group.name}>
                  ...
                  >
                    <TableCell sx={{ padding: "5px 0px", display: "flex", alignItems: "center", boxShadow: "none", borderBottom: "none"  , marginBottom : "0px" }}>
                      <IconButton size="small" onClick={() => toggleRow(group.name)}>
                        {openRows[group.name] ? <ArrowDropDownIcon sx={{ fontSize: 28, strokeWidth: 2, fontWeight: "700", color: "#000" }} /> : <ArrowDropUpIcon sx={{ fontSize: 28, strokeWidth: 2, fontWeight: "700", transform: "rotate(90deg)", color: "#000" }} />}
                      </IconButton>

                      <Box sx={{ fontSize: "18px", fontWeight: "500", marginLeft: "10px", color: "#000", fontFamily: "Calibri" }}>
                        {group.name}
                      </Box>
...
export default DonutDetailTable;
