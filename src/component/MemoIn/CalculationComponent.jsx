              ...
              >
                ...
                <Box sx={{ display: "flex" }}>
                  <TextField
                    ...
                    disabled={!state.useDiscountPercent || isDisabled}
                    type="number"
                    variant="outlined"
                    fullWidth
                    InputProps={{
            ...
            >
              ...
              <Box sx={{ display: "flex" }}>
                <TextField
                  ...
                  disabled={!state.useDiscountAmount || isDisabled}
                  variant="outlined"
                  type="number"
                  fullWidth
                  inputProps={{ inputMode: "numeric", pattern: "[0-9]*", sx:{
                    '&::-webkit-outer-spin-button': {
                           WebkitAppearance: 'none',
                           margin: 0,
                         },
              ...
              >
                ...
                <Box sx={{ display: "flex" }}>
                  <TextField
                    ...
                    type="number"
                    disabled={!state.useVAT || isDisabled}
                    variant="outlined"
                    fullWidth
                    InputProps={{
                      sx: {
