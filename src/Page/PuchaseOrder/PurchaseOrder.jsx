...
import { CustomerInvoiceAddressState, SelectedInvoiceAddressState } from "recoil/PurchaseOrder/VendorState";
...
const PurchaseOrder = () => {
 ...
 const [exchangeRate, setExchangeRateRaw] = useState("");
  ...
  useTransactionNavigationGuard(hasUnsavedData, resetPurchaseOrderState);
